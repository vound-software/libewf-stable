...
/*Reads buffer at specific offset , added by BxB in order to work with later version of libtsk*/
ssize_t libewf_handle_read_buffer_at_offset(
	...
	return libewf_handle_read_random(handle, buffer, buffer_size, offset, error);
}
